...
TRUNCATE TABLE `vehicle_maintenance_records`;
...
INSERT INTO `vehicles` (`id`, `category_id`, `vehicle_type`, `short_name`, `full_name`, `price_per_day`, `driver_age_requirement`, `image_path`, `number_of_seats`, `transmission_type`, `fuel_type`, `license_plate`, `status`, `gps_id`, `last_service_date`, `description`, `created_at`, `updated_at`) VALUES
  ...
  (13, 3, 'luxury', 'Maintenance', 'Mercedes-Benz SL-Class (R231)', 100, 21, 'images/luxury.png', 2, 'hybrid', 'petrol', 'BAA-4', 'maintenance', NULL, '2026-04-04', 'Mercedes-Benz SL-Class delivers premium grand touring comfort with high-performance engineering.', '2026-04-04 13:42:38', '2026-04-04 20:11:41'),
  (14, 2, 'bikes', 'Reserved Test Bike', 'Vespa ZX 125', 30, 18, 'images/bikes.png', 2, 'N/A', 'petrol', 'BAA-1721', 'reserved', '#45_A00', '2026-04-01', 'Vespa ZX 125 offers practical commuting performance with classic scooter styling.', '2026-04-04 15:47:43', '2026-04-04 23:53:25'),
  (15, 3, 'luxury', 'TCV g', 'Test Creation', 987, 21, 'uploads/vehicles/vehicle-20260404235647-a4103926ee.png', 1, 'automatic', 'electric', '0987', 'on_trip', '987', '2026-04-01', 'ojihgvsGj bk', '2026-04-04 23:56:47', '2026-04-04 23:56:47');

-- Table: vehicle_maintenance_records
INSERT INTO `vehicle_maintenance_records` (`id`, `vehicle_id`, `issue_description`, `workshop_name`, `estimate_completion_date`, `service_cost`, `status`, `completed_at`, `created_at`, `updated_at`) VALUES
  (1, 6, 'Break not working properly', 'Ridex Workshop Center', '2026-11-02', '20.00', 'completed', '2026-04-04 20:10:49', '2026-04-04 19:14:21', '2026-04-04 20:10:49'),
